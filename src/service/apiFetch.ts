...
async function fetchAnswerQuestions(question: string): Promise<string> {
...
async function fetchAnswerRoulette(question: string): Promise<string> {
...
export { fetchAnswerQuestions, fetchAnswerRoulette };
